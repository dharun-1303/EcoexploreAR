...
# Page Configuration
st.set_page_config(page_title="EcoExploreAR", page_icon="\U0001F331", layout="wide")

# Title and Banner
st.image("plant_banner.jpg", use_column_width=True)
...
st.image("ar_model_example.jpg", caption="AR Model of a Plant's Inner Structure", use_column_width=True)
...
st.image("cross_breeding_example.jpg", caption="Cross-Breeding Process", use_column_width=True)
